...
<div class="specific"><br><br>
  ...
  <h4><center>Tanggal <?php echo date("d-m-Y", strtotime($datapenduduk->tanggal)) ?></center></h4>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered center" id="dataTable" width="100%" cellspacing="0">                  
                      ...
                      <tr>
                          ...
                          <td class="text-primary"><?php echo date("d-m-Y", strtotime($datapenduduk->mulai_dishelter)) ?></td>
                      </tr> -->
                      <tr>
