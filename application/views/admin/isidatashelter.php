...
<div id="submit1">
  ...
  <input type="text" name="time"  hidden="" value="<?php echo date("h:i");?>">
      ...
      <input type="text" hidden name="alamatpenduduk" value="<?php echo $datap->alamat_ktp?>">
      ...
      <input type="text" hidden name="tempat_isolasipenduduk" value="<?php echo $datap->tempat_isolasi?>">
       <input type="file" hidden name="gambar_ktppenduduk" value="<?php echo base_url('assets/surat/'.$datap->gambar_ktp) ?>">
...
<div id="submit1">
 ...
 <button type="submit" class="btn btn-primary" style="margin-right: 5%;float: right;">Kirim</button>
