...
<center>
<H1>Selamat Sehat! Tetap jaga kondisi dan patuhi protokol kesehatan.</H1></center>
<button type="submit" class="btn btn-warning" onclick="location.href='<?php echo base_url('page/listdata'),'/',$data->link?>'" style="
    float: right;
"><i class="fas fa-user-plus"></i> Kembali </button>
