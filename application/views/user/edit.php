...
=======
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <?php } ?>
      <input type="file" class="form-control" name="gambar[]" value="<?php echo $penduduk->gambar_ktp?>" required="">
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control" name="gambar[]" value="<?php echo $penduduk->gambar_surat?>" required="">
